...
export const routes: Routes = [
	...
	{ path: 'account', component: AccountComponent, canActivate: [authGuard], children: [{ path: '', pathMatch: 'full', redirectTo: 'menu' }, { path: 'menu', component: AccountMenuComponent }, { path: 'orders', component: AccountOrdersComponent }] },
